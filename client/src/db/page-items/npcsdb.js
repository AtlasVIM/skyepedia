...
export const npcDB = [
    ...
    },
    {
        ...
        tables :{
            celestialRegion: [gc],
            type: [npc],
            alias: ['Eli', 'Laine', 'Izinski'],
            species: ['Kijin'],
            nationality: ['Kaczyslavic'],
